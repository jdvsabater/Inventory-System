        ...
        private void btnAddRecord_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        string[] row = { txtID.Text, txtProductName.Text, cbxManufacturer.Text, cbxType.Text, txtStatus.Text, dateTimePicker1.Text, stocksubmit.ToString(), txtAmount.Text, (((Convert.ToInt32(txtStock.Text)) * (Convert.ToInt32(txtPrice.Text)))).ToString(), txtPrice.Text, cbxStoreList.Text };
