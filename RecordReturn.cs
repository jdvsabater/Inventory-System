    ...
    public partial class RecordReturn : Form
    {
        ...
        private void btnAddRecord_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if ((txtProductName.Text == " ") && (cbxManufacturer.Text == " ") && (cbxType.Text == " ") && (txtStock.Text == "") && (txtStatus.Text == "") && (txtAmount.Text == " ") && (cbxStoreList.Text == " "))
                {
                ...
                else
                {
                    ...
                    {
                        string[] row = { txtID.Text, txtProductName.Text, cbxManufacturer.Text, cbxType.Text, txtStatus.Text, dateTimePicker1.Text, stocksubmit.ToString(), txtAmount.Text, (((Convert.ToInt32(txtStock.Text)) * (Convert.ToDouble(txtPrice.Text)))).ToString(), txtPrice.Text, cbxStoreList.Text };
        ...
        private void btnSubmit_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < dataGridView2.Rows.Count; i++)
                {
                    ...
                    cbxStoreList.Text = dataGridView2.Rows[i].Cells["StoreName"].Value.ToString();
